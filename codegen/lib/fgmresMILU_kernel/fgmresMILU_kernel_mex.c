 ...
 * %#m2c options:23bcf8fd050ad2b97d32ba0d30718cb2
 *
 */
...
static void __fgmresMILU_kernel_api(mxArray **plhs, const mxArray ** prhs) {
    struct0_T            A;
    emxArray_real_T      b;
    struct1_T            prec;
    int32_T              restart;
    ...
    if (mxGetNumberOfElements(prhs[0]) && mxGetClassID(prhs[0]) != mxSTRUCT_CLASS)
        mexErrMsgIdAndTxt("fgmresMILU_kernel:WrongInputType",
            "Input argument A has incorrect data type; struct is expected.");
    if (mxGetNumberOfElements(prhs[0]) != 1)
        mexErrMsgIdAndTxt("fgmresMILU_kernel:WrongSizeOfInputArg",
    ...
    marshallin_const_struct1_T(&param, prhs[8], "param");
    ...
    alias_mxArray_to_emxArray(prhs[9], (emxArray__common *)(&rowscal), "rowscal", 1);
    ...
    alias_mxArray_to_emxArray(prhs[10], (emxArray__common *)(&colscal), "colscal", 1);
    ...
    fgmresMILU_kernel(&A, &b, &prec, restart, rtol, maxit, &x0, verbose, &param, &rowscal, &colscal, &x, flag, iter, &resids);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs == 11) {
        if (nlhs > 4)
            mexErrMsgIdAndTxt("fgmresMILU_kernel:TooManyOutputArguments",
                "Too many output arguments for entry-point fgmresMILU_kernel.\n");
        /* Call the API function. */
        __fgmresMILU_kernel_api(outputs, prhs);
    }
    else
        mexErrMsgIdAndTxt("fgmresMILU_kernel:WrongNumberOfInputs",
            "Incorrect number of input variables for entry-point fgmresMILU_kernel.");
