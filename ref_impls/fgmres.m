...
%
%https://github.com/oseledets/TT-Toolbox/blob/master/solve/fgmres.m
...
for i=int32(1:2:length(varargin)-1)
    switch lower(varargin{i})
        case 'relaxation'
            relaxation = varargin{i+1};
        case 'max_iters'
            max_iters = int32(varargin{i+1});
        case 'restart'
            restart = int32(int32(varargin{i+1}));
        case 'x0'
            x = varargin{i+1};
        case 'verb'
            verb = int32(varargin{i+1});
        case 'tol_exit'
