...
)
{
    ...
    idxlst=(integer *)MAlloc((size_t)n*sizeof(integer),"ZSYMldl2bldl:idxlst");
    idxpos=(integer *)CAlloc((size_t)n,sizeof(integer),"ZSYMldl2bldl:idxpos");
    zbuff =(doublecomplex *)MAlloc((size_t)n*sizeof(doublecomplex),"ZSYMldl2bldl:zbuff");
    BLDbuff=(doublecomplex *)MAlloc(((size_t)BLDsize)*BLDsize*sizeof(doublecomplex),"ZSYMldl2bldl:BLDbuff");
