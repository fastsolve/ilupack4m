...
void mexFunction(
  ...
  if (transposename[0] == 't' || transposename[0] == 'T') {
    ...
    UT_ia = (integer *)MAlloc((size_t)(n + 1) * sizeof(integer *),
                              "Zgnl_inverse_aware:UT_ia");
    nz = U_ia[n];
    UT_ja = (integer *)MAlloc((size_t)nz * sizeof(integer *),
                              "Zgnl_inverse_aware:UT_ja");
    UT_valuesR = (double *)MAlloc((size_t)nz * sizeof(double *),
                                  "Zgnl_inverse_aware:UT_valuesR");
    UT_valuesI = (double *)MAlloc((size_t)nz * sizeof(double *),
                                  "Zgnl_inverse_aware:UT_valuesI");
  ...
  LL = (integer **)MAlloc((size_t)n * sizeof(integer *),
                          "Zgnl_inverse_aware:LL");
  nLL =
      (integer *)MAlloc((size_t)n * sizeof(integer), "Zgnl_inverse_aware:nLL");
  /* elbow buffer space */
  eLL =
      (integer *)MAlloc((size_t)n * sizeof(integer), "Zgnl_inverse_aware:nLL");
  ...
  UUT = (integer **)MAlloc((size_t)n * sizeof(integer *),
                           "Zgnl_inverse_aware:UUT");
  nUUT =
      (integer *)MAlloc((size_t)n * sizeof(integer), "Zgnl_inverse_aware:nUUT");
  /* elbow buffer space */
  eUUT =
      (integer *)MAlloc((size_t)n * sizeof(integer), "Zgnl_inverse_aware:eUUT");
