...
void mexFunction(
  ...
  mxArray *tmp, *fout, *A_input, *b_input, *x0_input, *x_output, *options_input,
      *PRE_input, *options_output;
  ...
  mwSize *irs, *jcs, *A_ja, /* row indices of input matrix A */
