/* $Id: Zinverse_aware.c 797 2015-08-07 20:44:18Z bolle $ */
/* ========================================================================== */
/* === Zinverse_aware mexFunction =========================================== */
/* ========================================================================== */
...
)
{
    ...
    integer         i,j,k,l,m,n,nz,p,q,r,s,ndense, *ibuff, **LL, *LLi, *LLj, *nLL, *eLL;
    doubleprecision *pr, *dbuff;
    size_t          mrows, ncols;
    double          *L_valuesR, *LL_valuesR, *L_valuesI, *LL_valuesI;
...
#ifdef PRINT_INFO
    mexPrintf("Zinverse_aware: input parameter L imported\n");fflush(stdout);
#endif
...
#ifdef PRINT_INFO
    mexPrintf("Zinverse_aware: input parameter ndense imported\n");fflush(stdout);
#endif
    
    /* pointer to list of nonzero entries, column-by-column */
    LL   =(integer **)MAlloc((size_t)n*sizeof(integer *),"Zinverse_aware:LL");
    nLL  =(integer *) MAlloc((size_t)n*sizeof(integer),  "Zinverse_aware:nLL");
    /* elbow buffer space */ 
    eLL  =(integer *) MAlloc((size_t)n*sizeof(integer),  "Zinverse_aware:nLL");
    /* integer buffer of size n */
    ibuff=(integer *) MAlloc((size_t)n*sizeof(integer),  "Zinverse_aware:ibuff");
	...
	LL[i]=(integer *) MAlloc((size_t)eLL[i]*sizeof(integer),"Zinverse_aware:LL[i]");
        /* copy indices */
...
#ifdef PRINT_INFO
    mexPrintf("Zinverse_aware: memory released\n");fflush(stdout);
#endif
