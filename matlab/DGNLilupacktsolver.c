/* $Id: DGNLilupacktsolver.c 796 2015-08-06 20:27:07Z bolle $ */
/* ========================================================================== */
...
void mexFunction(
  ...
  */
  ...
  /* get size of input matrix A */
  rhs =
      (double *)MAlloc((size_t)A.nr * sizeof(double), "DGNLilupacksolver:rhs");
  pr = mxGetPr(b_input);
  ...
  /* numerical solution */
  sol =
      (double *)MAlloc((size_t)A.nr * sizeof(double), "DGNLilupacksolver:sol");
  pr = mxGetPr(x0_input);
