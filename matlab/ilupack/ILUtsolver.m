function [x, options] = ILUtsolver(A, PREC, options, b, x0)
% [x, options] = ILUtsolver(A, PREC, options, b, x0)
% [x, options] = ILUtsolver(A, PREC, options, b)
% [x, options] = ILUtsolver(A, PREC, b, x0)
% [x, options] = ILUtsolver(A, PREC, b)
%
...
elseif ~myoptions.isreal & PREC(1).isreal
   ...
   if myoptions.ishermitian & (PREC(1).ishermitian|PREC(1).issymmetric)
	 ...
	 for i=1:size(b,2)
	     myx0=full(x0(:,i));
	     [x(:,i), myoptions]=conj(ZHPDDSPDilupacksolver(A,PREC,myoptions,...
		                                       conj(full(b(:,i))),myx0));
	     options.niter(i)=myoptions.niter;
	 end % for i
	 ...
	 for i=1:size(b,2)
	     myx0=full(x0(:,i));
	     [x(:,i), myoptions]=conj(ZHERDSPDilupacksolver(A,PREC,myoptions,...
		                                       conj(full(b(:,i))),myx0));
	     options.niter(i)=myoptions.niter;
	 end % for i
	 ...
	 for i=1:size(b,2)
	     myx0=full(x0(:,i));
	     [x(:,i), myoptions]=conj(ZHERDSYMilupacksolver(A,PREC,myoptions,...
		                                       conj(full(b(:,i))),myx0));
	     options.niter(i)=myoptions.niter;
	 end % for i
      end % if
   ...
   elseif ~myoptions.ishermitian & (PREC(1).ishermitian|PREC(1).issymmetric)
	 ...
	 for i=1:size(b,2)
	     myx0=full(x0(:,i));
	     [x(:,i), myoptions]=ZGNLDSPDilupacktsolver(A,PREC,myoptions,...
		                                       full(b(:,i)),myx0);
	     options.niter(i)=myoptions.niter;
	 end % for i
	 ...
	 for i=1:size(b,2)
	     myx0=full(x0(:,i));
	     [x(:,i), myoptions]=ZGNLDSYMilupacktsolver(A,PREC,myoptions,...
		                                       full(b(:,i)),myx0);
	     options.niter(i)=myoptions.niter;
	 end % for i
      end % if
   ...
   % in any case the preconditioner is unsymmetric -> GMRES	 
      ...
      for i=1:size(b,2)
	  myx0=full(x0(:,i));
	  [x(:,i), myoptions]=ZGNLDGNLilupacktsolver(A,PREC,myoptions,...
	                                            full(b(:,i)),myx0);
	  options.niter(i)=myoptions.niter;
      end % for i
...
% complex preconditioner, treat matrix also as complex
   ...
   if myoptions.ishermitian & PREC(1).ishermitian
	 ...
	 for i=1:size(b,2)
	     myx0=full(x0(:,i));
	     [x(:,i), myoptions]=conj(ZHPDilupacksolver(A,PREC,myoptions,...
		                                   conj(full(b(:,i))),myx0));
	     options.niter(i)=myoptions.niter;
	 end % for i
	 ...
	 for i=1:size(b,2)
	     myx0=full(x0(:,i));
	     [x(:,i), myoptions]=conj(ZHERHPDilupacksolver(A,PREC,myoptions,...
		                                      conj(full(b(:,i))),myx0));
	     options.niter(i)=myoptions.niter;
	 end % for i
	 ...
	 for i=1:size(b,2)
	     myx0=full(x0(:,i));
	     [x(:,i), myoptions]=conj(ZHERilupacksolver(A,PREC,myoptions,...
		                                   conj(full(b(:,i))),myx0));
	     options.niter(i)=myoptions.niter;
	 end % for i
      end % if
   ...
   elseif ~myoptions.ishermitian & PREC(1).ishermitian
	 ...
	 for i=1:size(b,2)
	     myx0=full(x0(:,i));
	     [x(:,i), myoptions]=ZGNLHPDilupacktsolver(A,PREC,myoptions,...
		                                       full(b(:,i)),myx0);
	     options.niter(i)=myoptions.niter;
	 end % for i
	 ...
	 for i=1:size(b,2)
	     myx0=full(x0(:,i));
	     [x(:,i), myoptions]=ZGNLHERilupacktsolver(A,PREC,myoptions,...
		                                      full(b(:,i)),myx0);
	     options.niter(i)=myoptions.niter;
	 end % for i
      end % if
   ...
   elseif ~myoptions.issymmetric & PREC(1).issymmetric
      ...
      for i=1:size(b,2)
	  myx0=full(x0(:,i));
	  [x(:,i), myoptions]=ZGNLSYMilupacktsolver(A,PREC,myoptions,...
	                                           full(b(:,i)),myx0);
	  options.niter(i)=myoptions.niter;
      end % for i
   ...
   % in any case the preconditioner is unsymmetric -> GMRES	 
      ...
      for i=1:size(b,2)
	  myx0=full(x0(:,i));
	  [x(:,i), myoptions]=ZGNLilupacktsolver(A,PREC,myoptions,...
	                                        full(b(:,i)),myx0);
	  options.niter(i)=myoptions.niter;
      end % for i
