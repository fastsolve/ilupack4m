...
void mexFunction(
  ...
  A.ia = (integer *)MAlloc((size_t)(A.nc + 1) * sizeof(integer),
                           "DSYMSPDilupackfactor");
  A.ja =
      (integer *)MAlloc((size_t)nnz * sizeof(integer), "DSYMSPDilupackfactor");
  ...
  */
  ...
  classIDflags =
      (mxClassID *)mxCalloc((size_t)nfields + 1, (size_t)sizeof(int));
