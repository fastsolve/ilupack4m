/* $Id: DGNLSYMilupacktsolver.c 796 2015-08-06 20:27:07Z bolle $ */
/* ========================================================================== */
...
void mexFunction(
  ...
  A.ia = (integer *)MAlloc((size_t)(A.nc + 1) * sizeof(integer),
                           "DGNLSYMilupacksolver");
  A.ja =
      (integer *)MAlloc((size_t)nnz * sizeof(integer), "DGNLSYMilupacksolver");
  ...
  */
  ...
  /* get size of input matrix A */
  rhs = (double *)MAlloc((size_t)A.nr * sizeof(double),
                         "DGNLSYMilupacksolver:rhs");
  pr = mxGetPr(b_input);
  ...
  /* numerical solution */
  sol = (double *)MAlloc((size_t)A.nr * sizeof(double),
                         "DGNLSYMilupacksolver:sol");
  pr = mxGetPr(x0_input);
