...
)
{
    ...
    A.nc=A.nr=mrows;
    A.ia=(integer *)MAlloc((size_t)(A.nc+1)*sizeof(integer),"symmwmilupackrcmsp");
    ...
    /* import ind */
    param.ind=(integer *) MAlloc((size_t)A.nc*sizeof(integer),"symmwmilupackrcmsp");
    ...
    invq=(integer *) MAlloc((size_t)A.nc*sizeof(integer),"symmwmilupackrcmsp");
    prowscale=(double *) MAlloc((size_t)A.nc*sizeof(double),"symmwmilupackrcmsp");
    pcolscale=prowscale;
...
#else /* MUMPS matching */
    ierr=DSYMperm_matching_rcm_sp(A, prowscale, pcolscale, p, invq, &nB, &param);
#endif
