/* $Id: DGNLSPDilupacktsolver.c 796 2015-08-06 20:27:07Z bolle $ */
/* ========================================================================== */
...
void mexFunction(
  ...
  A.ia = (integer *)MAlloc((size_t)(A.nc + 1) * sizeof(integer),
                           "DGNLSPDilupacksolver");
  A.ja =
      (integer *)MAlloc((size_t)nnz * sizeof(integer), "DGNLSPDilupacksolver");
