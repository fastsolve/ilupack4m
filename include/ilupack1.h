...
_CPP_PREFIX integer    DGNLperm_matching_null       (Dmat, doubleprecision *,doubleprecision *,
            		 integer *,integer *, integer *, DILUPACKparam *);
...
_CPP_PREFIX void ILUPACK_TreeComputation(integer nleaves, integer * ddist,
                                         integer *rangtab, integer *treetab);
