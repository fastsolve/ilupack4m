...
%fgmresMILU_HO Kernel of fgmresMILU using Householder
%
%   x = fgmresMILU_HO(A, b, prec, restart, rtol, maxit, x0, verbose, nthreads, param)
%   x = fgmresMILU_HO(A, b, prec, restart, rtol, maxit, x0, verbose, nthreads, param, rowscal, colscal)
%
%   [x, flag, iter, resids] = fgmresMILU_HO(...)
%
% See also: fgmresMILU, fgmresMILU_GS
