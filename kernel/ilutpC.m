function [L, U, E, F, S, p, q] = ilutpC(A)
% ilutpC Crout version of ILU with thresholding and pivoting
%    [L, U, E, F, S, p, q] = ilutpC(A)

% Adapted from ITSOL v2.0
...
Lnnz = int32(0);
Lfirst = zeros(n, 1, 'int32');
Llist = zeros(n, 1, 'int32');
Lid = zeros(n, 1, 'int32');

Unnz = int32(0);
Ufirst = zeros(n, 1, 'int32');
Ulist = zeros(n, 1, 'int32');
Uid = zeros(n, 1, 'int32');
