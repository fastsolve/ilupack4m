#ifndef FGMRESMILU_MGS_H
#define FGMRESMILU_MGS_H
#include <math.h>
#include <stddef.h>
#include <stdlib.h>
#include <string.h>
#include "rtwtypes.h"
#include "fgmresMILU_MGS_types.h"

extern void fgmresMILU_MGS(const struct0_T *A, const emxArray_real_T *b, const
...
extern void fgmresMILU_MGS_initialize(void);
extern void fgmresMILU_MGS_terminate(void);
