...
void fgmresMILU_GS(const struct0_T *A, const emxArray_real_T *b, const struct1_T
...
void fgmresMILU_GS_initialize(void)
{
}

void fgmresMILU_GS_terminate(void)
{
}
